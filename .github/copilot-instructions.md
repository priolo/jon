...
The library implements the **RVX** pattern (Reducer/View/X), centering around **Stores** defined by a setup object.
...
- **`actions`**: Asynchronous functions for side effects or complex logic.
